...
";
        ...
        {
            DotLiquid.Template.RegisterSafeType(typeof(EnumType), new string[] { "Hash", "Name", "Location", "Values" });
            DotLiquid.Template.RegisterSafeType(typeof(EnumValue), new string[] { "Name", "Value" });
